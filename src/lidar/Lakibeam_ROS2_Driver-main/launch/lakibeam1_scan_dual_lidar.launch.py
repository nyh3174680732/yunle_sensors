...
def generate_launch_description():
    ...
    port_back = LaunchConfiguration('port_back')
    ...
    # port_front = LaunchConfiguration('port_front',default='2368')
    # port_back = LaunchConfiguration('port_back',default='2369')
    ...
    declare_port_front_cmd = DeclareLaunchArgument(
    'port_front',
    default_value='"2368"',
    )
    declare_port_back_cmd = DeclareLaunchArgument(
    'port_back',
    default_value='"2369"',
    )
    ...
    ld.add_action(declare_port_front_cmd)
    ld.add_action(declare_port_back_cmd)
